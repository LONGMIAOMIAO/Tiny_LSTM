...
#   LSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTMLSTM
...
#   GRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRUGRU
class GRU(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
...
#   RNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNNRNN
#   注意RNN的学习率要设置为 0.001
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
